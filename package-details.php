			...
			<div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
				<ul>
					...
					{?>
						...
						<!-- display QR code to pay -->
						<p>Pay And Book</p>
			 <img class="qr-code" src="<?php echo $dataUri; ?>" alt="QR Code"><br>
			 <button type="submit" name="submit2" class="btn-primary btn">Book</button><br>
...
<?php
// $imagePath = 'qr_code.png'; // Replace with the actual path to your image
